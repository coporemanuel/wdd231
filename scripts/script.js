...
// Function to display course buttons dynamically
function displayCourses(filteredCourses) {
    const courseCards = document.getElementById("course-cards");
    courseCards.innerHTML = "";

    // Create a container for the course buttons with grid layout
    const courseList = document.createElement("div");
    courseList.className = "course-list";

    // Iterate through filtered courses and create course buttons
    filteredCourses.forEach(course => {
        const courseButton = document.createElement("button");
        courseButton.className = "course-list-buttons";
        courseButton.textContent = `${course.subject} ${course.number}`;
        courseButton.onclick = () => showCourseDetails(course.number);
    ...
    courseCards.appendChild(courseList);
